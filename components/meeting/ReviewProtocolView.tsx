...
export default function ReviewProtocolView({
  meeting,
}: ReviewProtocolViewProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Review & Edit Your Protocol</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Edit your protocol here..."
            />
          </div>
      ...
      <CardFooter className="flex justify-end gap-2">
        ...
        <Button onClick={handleApprove} disabled={isLoading}>
          {isLoading ? "Approving..." : "Approve & Save Protocol"}
        </Button>
      </CardFooter>
    </Card>
  );
