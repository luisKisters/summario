...
1. **EXTREME PRECISION IN UPDATES - ONLY MODIFY WHAT IS REQUESTED:**
   ...
   - **DO NOT MODIFY, ALTER, OR UPDATE ANY OTHER PARTS OF THE MINUTES UNDER ANY CIRCUMSTANCES.**
...
2. **PRESERVE USER'S EXACT TONE AND STYLE:**
   - **MAINTAIN THE EXACT TONE, VOICE, AND WRITING STYLE FROM THE ORIGINAL MINUTES CONTENT.**
...
Current minutes content:
${current_content}

User's edit instruction: "${edit_instruction}"

Please apply this edit instruction to the minutes content following the critical instructions above.
